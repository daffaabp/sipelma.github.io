...
if (isset($_POST["submit"])) {
     ...
     if (tambah($_POST) > 0) {
          ...
          echo "<script>alert('Data Berhasil Ditambahkan!');document.location.href = '../dashboard/data_mahasiswa.php';</script>";
     } else {
          // echo "Data Gagal Ditambahkan!";
          echo "<script>
alert('Data Gagal Ditambahkan!');
document.location.href = '../dashboard/tambah_mahasiswa.php';
</script>";
     }
}
?>
                    ...
                    <div class="row g-4">
                         <div class="col-12">
                              <div class="bg-light rounded h-100 p-4">
                                   <h3 class="mb-4" style="text-align: center;">Tambah Data Mahasiswa</h3>
                                   <div class="table-responsive">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="inputJenis" class="form-select" name="jenis">
                                             ...
                                             <div class="mb-2">
                                                  ...
                                                  <input type="text" class="form-control" name="jenis"
                                                       id="exampleInputJenis" required>
                                             </div>

                                             <div class="mb-2">
                                                  <label for="exampleInputProdi" class="form-label">Prodi :</label>
                                                  <input type="text" class="form-control" name="prodi"
                                                       id="exampleInputProdi" required>
                                             </div>

                                             <!-- <div class="form-group">
                                        <div class="col-md-12">
                                            <label for="inputProdi" class="form-label">Program Studi </label>
                                            <select id="inputProdi" class="form-select" name="prodi">
                                                <option value="Teknik Informatika">Teknik Informatika</option>
                                                <option value="Rekayasa Keamanan Siber">Rekayasa Keamanan Siber</option>
                                                <option value="Teknik Pengendalian Pencemaran Lingkungan">Teknik
                                                    Pengendalian Pencemaran
                                                    Lingkungan</option>
                                                <option value="Teknik Mesin">Teknik Mesin</option>
                                                <option value="Teknik Elektro">Teknik Elektro</option>
                                                <option value="Teknik Listrik">Teknik Listrik</option>
                                                <option value="Pengembangan Produk Agroindustri">Pengembangan Produk
                                                    Agroindustri</option>
                                            </select>
                                        </div>
                                    </div> -->
                                             ...
                                             <div class="mb-2">
                                                  ...
                                                  <input type="text" class="form-control" name="alamat"
                                                       id="exampleInputAlamat" required>
                                             </div>
                                             ...
                                             <button type="submit" name="submit" class="btn btn-primary float-end"
                                                  id="btn-tambah"><i class="fas fa-save"></i> Submit</button>
