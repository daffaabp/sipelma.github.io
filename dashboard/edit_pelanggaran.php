...
// Untuk menghubungkannya, kita menggunakan require
...
$pelanggaran = queryPelanggaranById($id_pelanggaran);
...
if (isset($_POST["submit"])) {
     ...
     if (editPelanggaran($_POST) > 0) {
          // echo "Data Berhasil Ditambahkan!";
          echo "<script>alert('Pelanggaran Berhasil Diubah!');document.location.href = 'list_pelanggaran.php';</script>";
     } else {
          // echo "Data Gagal Ditambahkan!";
          echo "<script>alert('Pelanggaran Gagal Diubah!');document.location.href = 'list_pelanggaran.php';</script>";
     }
}
?>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="data_mahasiswa.php" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Data
                        Mahasiswa</a>
                    <a href="tambah_pelanggaran.php" class="nav-item nav-link" style="font-size: 14px;"><i
                            class="fa fa-table me-2"></i>Tambah
                        Pelanggaran</a>
                    <a href="list_pelanggaran.php" class="nav-item nav-link active"><i
                            class="fa fa-chart-bar me-2"></i>List
                        Pelanggaran</a>
                ...
                <div class="row g-4">
                    <div class="col-12">
                        <div class="bg-light rounded h-100 p-4">
                            <h3 class="mb-4" style="text-align: center;">Edit Data Pelanggaran</h3>
                                ...
                                <form action="" method="post">
                                    ...
                                    <div class="mb-2">
                                        <input type="hidden" class="form-control" name="id_pelanggaran"
                                            id="id_pelanggaran" required value="<?= $row["id_pelanggaran"]; ?>">
                                    </div>
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <input type="text" class="form-control" name="prodi" id="exampleInputProdi"
                                            required disabled value="<?= $row["prodi"]; ?>" disabled>
                                    </div>

                                    <div class="mb-2">
                                        <label for="exampleInputJenis" class="form-label">Jenis
                                            Pelanggaran
                                            :</label>
                                        <select class="form-control" name="jenis_pelanggaran" id="jenis_pelanggaran">
                                            <option value="<?= $row["jenis_pelanggaran"]; ?>" selected>
                                                <?= $row["jenis_pelanggaran"]; ?>
                                            </option>
                                            <option value="Bolos">Bolos</option>
                                            <option value="Nyontek">Nyontek</option>
                                            <option value="Ngrokok">Ngrokok</option>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label for="exampleInputTanggal" class="form-label">Tanggal
                                                Pelanggaran :</label>
                                            <input type="date" class="form-control" name="tanggal"
                                                id="exampleInputTanggal" required value="<?= $row["tanggal"]; ?>">
                                        </div>

                                        <div class="col-md-6">
                                            <label for="exampleInputPoint" class="form-label">Point
                                                :</label>
                                            <input type="number" class="form-control" name="point" id="point"
                                                placeholder="Masukkan point" value="<?= $row["point"]; ?>" required>
                                        </div>
                                    </div>


                                    <br>
                                    <a href="list_pelanggaran.php" type="button" name="kembali"
